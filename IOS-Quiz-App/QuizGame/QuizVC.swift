...
class QuizVC: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        let que1 = Question(imgName: "img1", questionText: "Cat", options: ["كلب", "قطّة", "حمار", "عجل"], correctAns: 1, wrongAns: -1, isAnswered: false)
        let que2 = Question(imgName: "img2", questionText: "Dog", options: ["جاموس", "بهيمة", "قطّة", "كلب"], correctAns: 3, wrongAns: -1, isAnswered: false)
        let que3 = Question(imgName: "img3", questionText: "horse", options: ["بهيمة", "غنم", "حصان", "عجل"], correctAns: 2, wrongAns: -1, isAnswered: false)
        let que4 = Question(imgName: "img4", questionText: "Duck", options: ["اوزة", "عصفور", "فأر", "بطة"], correctAns: 3, wrongAns: -1, isAnswered: false)
        let que5 = Question(imgName: "img5", questionText: "Lion", options: ["أسد", "روبيان", "قرد", "فرس"], correctAns: 0, wrongAns: -1, isAnswered: false)
        let que6 = Question(imgName: "img6", questionText: "Ant", options: ["ذبابة", "حشرة", "نملة", "عقربة"], correctAns: 2, wrongAns: -1, isAnswered: false)
